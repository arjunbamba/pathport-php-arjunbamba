...
//Base Statement
$sql = "DELETE FROM recommendations WHERE rec_id=" . $_GET["rec_id"] . ";"; 
  ...
  <div class="container" style="text-align: center;">
    <div class="row mt-4">
      <div class="col-12">
        ...
        <?php if ( $isDeleted ) :?>
          <div class="text-success">Success! <span class="font-italic"><?php echo $_GET['rec'];?></span> has been deleted.</div>
        <?php endif; ?>
    ...
    <div class="row mt-4 mb-4">
      <div class="col-12">
        <a href="browse_results.php" role="button" class="btn btn-primary">Back to Browse</a>
      </div> <!-- .col -->
    </div> <!-- .row -->
  </div> <!-- .container -->
