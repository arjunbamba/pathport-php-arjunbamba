...
<div class="my_heading">
  <p>Register for your personalized account!</p>
</div> 
...
<div class="my_spacing"></div>
  ...
  <div class="container">
    ...
    <form action="registered_confirmation.php" method="POST" class="mt-3">
      ...
      <div class="form-group row">
        ...
        <div id="fname_error" style="display: none; color: red;">First Name is required.</div>
      </div> <!-- .form-group -->
      ...
      <div class="form-group row">
        ...
        <div id="lname_error" style="display: none; color: red;">Last Name is required.</div>
      </div> <!-- .form-group -->
  ...
  <script>
    ...
    document.querySelector('form').onsubmit = function(){
      ...
      if ( document.querySelector('#lname-id').value.trim().length == 0 ) {
        ...
        document.querySelector('#lname_error').style.display = "block";
      } 
      else {
        document.querySelector('#lname-id').classList.remove('is-invalid');
        document.querySelector('#lname_error').style.display = "none";
      }
